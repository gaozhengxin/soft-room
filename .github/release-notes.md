...
Android's built-in TURN relay is not enabled for this first APK. Direct/STUN connections and a custom TURN setting remain available; cross-network channels that require the built-in relay may not connect.
