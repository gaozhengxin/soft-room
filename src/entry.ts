...
document.documentElement.lang=language==='zh'?'zh-CN':'en';document.documentElement.dataset.theme='sssp';
document.documentElement.dataset.device=info.device;document.documentElement.dataset.platform=info.platform;
