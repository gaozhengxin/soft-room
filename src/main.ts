...
sidebar.insertAdjacentHTML('beforeend','<div class="sidebar-bottom"><button id="my-identity" class="profile-button"><span class="avatar">✳</span><span><b id="identity"></b><small data-i18n="temporaryIdentity"></small></span></button><p data-i18n="temporaryShort"></p></div>');
