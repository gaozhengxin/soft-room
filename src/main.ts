...
const ipaLink='https://github.com/gaozhengxin/soft-room/releases/latest/download/Soft-Room.ipa';
sidebar.querySelector('.sidebar-bottom')!.insertAdjacentHTML('afterbegin',`<div class="release-links"><a class="release-link" href="${releaseLink}" target="_blank" rel="noopener noreferrer" data-label="releases">${downloadIcon}<span data-i18n="releases"></span></a><a class="release-link mobile-download" href="${ipaLink}" target="_blank" rel="noopener noreferrer" data-label="downloadUpdate">${downloadIcon}<span data-i18n="downloadUpdate"></span></a></div>`);
