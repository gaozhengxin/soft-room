...
export class RoomMesh {
 ...
 private makePeer(key:string,instance:string,id:string):Peer{
  ...
  const pc=this.options.peerConnection?.(this.options.rtcConfiguration||(this.customTurn?{iceServers:[...defaultIceServers,this.customTurn],bundlePolicy:'max-bundle'}:undefined)||this.iceConfiguration||{iceServers:defaultIceServers,bundlePolicy:'max-bundle'})||new RTCPeerConnection(this.options.rtcConfiguration||(this.customTurn?{iceServers:[...defaultIceServers,this.customTurn],bundlePolicy:'max-bundle'}:undefined)||this.iceConfiguration||{iceServers:defaultIceServers,bundlePolicy:'max-bundle'});
