...
const bypassDigest=process.env.REGION_BYPASS_DIGEST||'';
...
try{
 ...
 for(let i=0;i<2;i++){
  ...
  if(bypassDigest)await context.addInitScript(digest=>sessionStorage.setItem('soft-room-region-bypass-v1',digest),bypassDigest);
