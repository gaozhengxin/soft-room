...
try{
 ...
 await page.goto('https://127.0.0.1:5173/');await continueTemporary(page);await page.locator('#sidebar-toggle').click();await page.locator('#new-room').click();await page.locator('#room-name').fill('Relay settings');await page.locator('.toggle').click();await page.locator('#create-button').click();await page.waitForFunction(()=>!document.querySelector('#send')?.disabled,null,{timeout:90000});
